...
macro(set_vcpkg_config)
    ...
    if(NOT DEFINED local_VCPKG_TARGET_TRIPLET)
        if(NOT DEFINED VCPKG_TARGET_TRIPLET)
            ...
            elseif(APPLE)
                ...
                elseif(CMAKE_OSX_ARCHITECTURES MATCHES "x86_64")
                    ...
                    # Default to native architecture detection
        ...
        # Don't override with windows if already set above
        if(NOT VCPKG_TARGET_TRIPLET STREQUAL "x64-windows" AND NOT VCPKG_TARGET_TRIPLET MATCHES "osx|linux")
            set(VCPKG_TARGET_TRIPLET "x64-windows" CACHE STRING "Vcpkg target triplet")
        endif()
    else()
...
elseif(DEFINED ENV{VCPKG_INSTALLATION_ROOT})
    ...
    set_vcpkg_config()
    message(STATUS "VCPKG_INSTALLATION_ROOT found in the environment")
elseif(EXISTS "${CMAKE_SOURCE_DIR}/../vcpkg/scripts/buildsystems/vcpkg.cmake")
    get_filename_component(VCPKG_ROOT "${CMAKE_SOURCE_DIR}/../vcpkg" ABSOLUTE)
    set(ENV{VCPKG_ROOT} "${VCPKG_ROOT}")
    set_vcpkg_config()
    message(STATUS "repo-local vcpkg found at ${VCPKG_ROOT}")
else()
    # load VCPKG_ROOT from the .vcpkg-root file
